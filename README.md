...
- **Achats (Registre des achats)** : ajout, **modification** et **suppression** de chaque bon d'achat. Chaque ligne de produit reçu a son propre bouton **Scanner** (caméra) et une zone de saisie du code produit (SKU) pour sélectionner rapidement le bon article sans chercher dans la liste déroulante.
- **Stock** : vue par lot avec **modification** (ouvre l'achat d'origine) et **suppression** d'un lot précis.
- **Ventes (caisse)** : encaissement, paiement partiel/à crédit, reçus imprimables.
- **Ventes (Historique)** : **modification** (paiement, client, réduction, montant payé) et **suppression** (remet automatiquement le stock vendu à disposition) de chaque vente.
