  ...
  <div class="modal-overlay" role="dialog" aria-modal="true" id="productModalOverlay">
    <div class="modal">
      ...
      <div class="field-row">
        ...
        <div class="field"><label>N Bon</label><input id="f_purchase_bon" placeholder="BA-0001" maxlength="40"></div>
      </div>
      <div class="field-row">
...
function renderPurchaseRegister() {
  ...
  return `
    ...
    <div class="card">
      ...
      <table class="rcard">
        <thead><tr><th>N Bon</th><th>Date</th><th>Fournisseur</th><th>Produits</th><th style="text-align:right;">Coût total</th><th>Actions</th></tr></thead>
        <tbody>
          ${sorted.map(pu => {
