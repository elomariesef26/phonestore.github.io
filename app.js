...
async function restoreFromFile(file) {
  ...
  try {
    ...
    const results = await Promise.all([
      ...
      saveOplog(), saveSuppliers(), savePurchases(), saveInvoices(), safeSet('shop:theme-pref', state.theme, false), safeSet('shop:branding', JSON.stringify(state.branding), false),
    ]);
