...
function renderPurchaseModal() {
  const lines = state.purchaseDraftLines || [{ id: uid('pl'), productId: '', qty: '', unitCost: '', unitPrice: '' }];
  return `
    ...
    <div class="modal modal-wide">
      ...
      <div class="field"><label>Produits reçus</label>
        <div id="purchaseLines">
          ${lines.map(l => `
            <div class="field-row" style="grid-template-columns:1.6fr .8fr .9fr .9fr auto;align-items:end;gap:8px;margin-bottom:8px;">
    ...
    <div class="card">
      ...
      <table class="rcard">
        <thead><tr>
          ...
          <th style="text-align:right;">Prix de vente</th><th style="text-align:right;">Stock actuel</th>
        </tr></thead>
        <tbody>
          ${rows.map(r => {
...
function bindEvents() {
  ...
  if (addPurchaseBtn) addPurchaseBtn.addEventListener('click', () => {
    state.purchaseDraftLines = [{ id: uid('pl'), productId: '', qty: '', unitCost: '', unitPrice: '' }];
  ...
  if (addPurchaseLine) addPurchaseLine.addEventListener('click', () => {
    state.purchaseDraftLines.push({ id: uid('pl'), productId: '', qty: '', unitCost: '', unitPrice: '' });
    render();
  });
